    ...
    <Container className="mt-5">
      <div className="section-3">
        ...
        <div className="section3-content">
          <p className="fs-20 fw-700 font-play">Hello! I'm Taghavi</p>
          <p className="fs-14 font-mulish">
            A dedicated member of the American Immigration Lawyers Association
            (AILA)
          </p>
          <p className="fs-56 fw-700 lh-1 font-mulish">I'll Be Your Dedicated Guide</p>
          <p className="fs-14 font-mulish">
